function(auras)
    ...
    or (aura_env.DotRemainingTime(spells.FrostFever) < 1.5 and aura_env.Cast(spells.Pestilence))
    ...
    or (aura_env.DotRemainingTime(spells.FrostFever) < 8.5 and aura_env.Cast(spells.Pestilence))
    or (aura_env.AuraIsActive(spells.Rime) and aura_env.Cast(spells.HowlingBlast))

function(auras)
    ...
    aura_env.Update(auras, function()
        return (aura_env.RunicPower() >= 40 and aura_env.Cast(spells.RuneStrike))
        ...
        or (aura_env.DotRemainingTime(spells.FrostFever) < 3 and aura_env.DotIsActive(spells.FrostFever) and aura_env.Cast(spells.Pestilence))
